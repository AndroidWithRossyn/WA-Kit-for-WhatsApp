...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    private CamHandlerThread mCameraHandlerThread;
    private CamWrapper mCameraWrapper;
    ...
    public final void setupLayout(CamWrapper cameraWrapper) {
        removeAllViews();
        mPreview = new CamPreview(getContext(), cameraWrapper, this);
    ...
    public void startCamera(int i) {
        if (mCameraHandlerThread == null) {
            mCameraHandlerThread = new CamHandlerThread(this);
        }
        mCameraHandlerThread.startCamera(i);
    }

    public void setupCameraPreview(CamWrapper cameraWrapper) {
    ...
    public void startCamera() {
        startCamera(CamUtils.getDefaultCameraId());
    }

    public void stopCamera() {
        if (mCameraWrapper != null) {
            mPreview.stopCameraPreview();
            mPreview.setCamera((CamWrapper) null, (Camera.PreviewCallback) null);
    ...
    public void setFlash(boolean z) {
        ...
        if (mCameraWrapper != null && CamUtils.isFlashSupported(mCameraWrapper.mCamera)) {
    ...
    public boolean getFlash() {
        ...
        if (mCameraWrapper == null || !CamUtils.isFlashSupported(mCameraWrapper.mCamera) || !mCameraWrapper.mCamera.getParameters().getFlashMode().equals("torch")) {
            return false;
        }
        return true;
    }
