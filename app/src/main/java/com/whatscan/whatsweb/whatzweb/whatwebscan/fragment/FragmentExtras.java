...
import com.whatscan.whatsweb.whatzweb.whatwebscan.databinding.FragExtrasBinding;
import com.whatscan.whatsweb.whatzweb.whatwebscan.screens.ActivityAboutUs;
...
public class FragmentExtras extends Fragment implements View.OnClickListener, IEventListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tvAboutUs:
                startActivity(new Intent(requireActivity(), ActivityAboutUs.class));
                break;
            case R.id.tvMore:
