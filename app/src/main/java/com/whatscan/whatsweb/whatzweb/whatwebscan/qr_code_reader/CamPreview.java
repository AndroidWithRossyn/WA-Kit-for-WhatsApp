...
public class CamPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CamWrapper mCameraWrapper;
    ...
    public CamPreview(Context context, CamWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public CamPreview(Context context, AttributeSet attributeSet, CamWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attributeSet);
        init(cameraWrapper, previewCallback);
    }

    public void init(CamWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    public void setCamera(CamWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    private Camera.Size getOptimalPreviewSize() {
        ...
        if (DisplayUtil.getScreenOrientation(getContext()) == 1) {
            int i = height;
            height = width;
            width = i;
        }
