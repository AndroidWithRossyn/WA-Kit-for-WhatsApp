...
import com.whatscan.whatsweb.whatzweb.whatwebscan.Utils.SharedPrefsHelper;
...
import com.whatscan.whatsweb.whatzweb.whatwebscan.databinding.ActReplyBinding;

import java.lang.reflect.Type;
import java.util.ArrayList;

public class ActivityReply extends AppCompatActivity implements IEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.replyRecycler.setLayoutManager(new LinearLayoutManager(ActivityReply.this));
        ...
        binding.addFloatingBtn.setOnClickListener(v -> {
            ...
            alert.showDialog(ActivityReply.this);
    ...
    public void notifyItems() {
        ...
        adapterReply = new RepeaterReply(ActivityReply.this, parentArrayList, new ReplyListener() {
            @Override
            public void onClickEdit(String s, int layoutrPosition) {
                ViewDialog alert = new ViewDialog();
                alert.showDialog(ActivityReply.this,s,layoutrPosition);
            }

            @Override
            public void onClickCopy(String s) {
                ConstMethod.CopyToClipBoard(ActivityReply.this,s);
            }
            ...
            public void onClickShare(String s) {
                if (!TextUtils.isEmpty(s)) {
                    ...
                    try {
                        ...
                        Toast.makeText(ActivityReply.this, "Whatsapp have not been installed.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ActivityReply.this, "Empty string.", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public class ViewDialog {
        ...
        public void showDialog(ActivityReply replyActivity, String s, int layoutrPosition) {
