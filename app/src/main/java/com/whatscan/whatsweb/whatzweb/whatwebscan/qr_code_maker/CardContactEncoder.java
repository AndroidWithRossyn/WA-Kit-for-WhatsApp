...
final class CardContactEncoder extends ContactEncoder {
    ...
    public String[] encode(List<String> names,
        ...
        Formatter fieldFormatter = new CardFieldFormatter();
        ...
        appendUpToUnique(newContents, newDisplayContents, "TEL", phones, Integer.MAX_VALUE,
                new CardTelDisplayFormatter(phoneMetadata),
                new CardFieldFormatter(phoneMetadata), TERMINATOR);
