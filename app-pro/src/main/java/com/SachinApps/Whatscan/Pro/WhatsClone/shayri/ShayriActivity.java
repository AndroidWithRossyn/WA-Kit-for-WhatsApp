...
import com.SachinApps.Whatscan.Pro.WhatsClone.databinding.ActShayriBinding;
...
public class ShayriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnCopy.setOnClickListener(v -> ConstMethod.CopyToClipBoard(ShayriActivity.this, copyFormList.get(binding.viewPager.getCurrentItem())));
