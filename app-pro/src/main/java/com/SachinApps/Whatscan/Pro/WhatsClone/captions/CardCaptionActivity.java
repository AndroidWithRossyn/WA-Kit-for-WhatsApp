...
import com.SachinApps.Whatscan.Pro.WhatsClone.databinding.ActCardCaptionBinding;
...
//                Log.d("Details-->", jo_inside.getString("quotes"));
        ...
        binding.btnCopy.setOnClickListener(v -> ConstMethod.CopyToClipBoard(CardCaptionActivity.this, copyFormList.get(binding.viewPager.getCurrentItem()).get("quoteText")));
