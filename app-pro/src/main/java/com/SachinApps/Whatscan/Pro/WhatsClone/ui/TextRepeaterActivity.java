...
import com.SachinApps.Whatscan.Pro.WhatsClone.databinding.ActTextRepeaterBinding;
...
public class TextRepeaterActivity extends AppCompatActivity implements IEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!UserHelper.getBooleanValue(UserHelper.IS_PRO) && UserHelper.getBooleanValue(UserHelper.Adshow) && UserHelper.getBooleanValue(UserHelper.showInterstitial) && UserHelper.getStringValue(UserHelper.bannerAdId) != null) {
            ...
            AdsManager.loadNativeAds(TextRepeaterActivity.this, binding.flAdplaceholder, UserHelper.getStringValue(UserHelper.nativeAdId));
        }
