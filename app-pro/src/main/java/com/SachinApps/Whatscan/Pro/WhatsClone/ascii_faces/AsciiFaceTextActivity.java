...
import com.SachinApps.Whatscan.Pro.WhatsClone.databinding.ActAsciiFaceTextBinding;
import com.SachinApps.Whatscan.Pro.WhatsClone.R;


public class AsciiFaceTextActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!UserHelper.getBooleanValue(UserHelper.IS_PRO) && UserHelper.getBooleanValue(UserHelper.Adshow) && UserHelper.getBooleanValue(UserHelper.showInterstitial) && UserHelper.getStringValue(UserHelper.bannerAdId) != null) {
            ...
            AdsManager.loadInterAd(AsciiFaceTextActivity.this, UserHelper.getStringValue(UserHelper.interstitialAdId));
            AdsManager.loadNativeAds(AsciiFaceTextActivity.this, binding.flAdplaceholder, UserHelper.getStringValue(UserHelper.nativeAdId));
        }
    }

    public void startActivityes(Intent intent) {
        AdsManager.adCounter++;
        AdsManager.showInterAd(AsciiFaceTextActivity.this, UserHelper.getStringValue(UserHelper.interstitialAdId), intent, 0);
    }
