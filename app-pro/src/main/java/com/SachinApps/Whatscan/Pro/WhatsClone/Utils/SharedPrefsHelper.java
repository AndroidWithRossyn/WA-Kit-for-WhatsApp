...
import com.SachinApps.Whatscan.Pro.WhatsClone.MyApp;
...
public class SharedPrefsHelper {
    ...
    private SharedPrefsHelper() {
        mSharedPreferences = MyApp.Companion.getInstance().getSharedPreferences(UserHelper.MY_PREFERANCE, Context.MODE_PRIVATE);
