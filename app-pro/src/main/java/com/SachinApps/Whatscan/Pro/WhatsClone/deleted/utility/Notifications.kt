package com.SachinApps.Whatscan.Pro.WhatsClone.deleted.utility
...
class Notifications @Inject constructor(@ApplicationContext private val context: Context) {
    fun notify(user: String, title: String, message: String,app: String) {
        val intent = Intent(context, DeletedMainActivity::class.java)
        ...
        val notificationBuilder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.e_booster)
