...
import com.SachinApps.Whatscan.Pro.WhatsClone.databinding.RowReplyMsgBinding;
...
public class ReplyAdapter extends RecyclerView.Adapter<ReplyAdapter.ViewHolder> {
    ...
    public ReplyAdapter(Activity activity, ArrayList<String> parentArrayList, ReplyListener replyListener) {
